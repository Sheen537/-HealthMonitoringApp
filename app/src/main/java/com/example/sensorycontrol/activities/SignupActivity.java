...
/**
 * Signup screen - Email/Password and Google registration
 */
public class SignupActivity extends AppCompatActivity {
    ...
    private void handleGoogleSignInResult(Task<GoogleSignInAccount> completedTask) {
        try {
            ...
            showLoadingDialog("Signing in with Google...", "Please wait while we set up your account");
            ...
            authManager.signInWithGoogle(completedTask, new AuthManager.AuthCallback() {
                ...
                public void onSuccess() {
                    runOnUiThread(() -> {
                        ...
                        showProgress(false);
                        showSuccessDialog("Welcome!", "Your account has been created successfully!", true);
                    });
                }
    ...
    private void attemptSignup() {
        ...
        // Show progress
        showProgress(true);
        showLoadingDialog("Creating Your Account", "Setting up your profile and securing your data...");
        ...
        authManager.signUp(email, password, name, new AuthManager.AuthCallback() {
            ...
            public void onSuccess() {
                runOnUiThread(() -> {
                    ...
                    showSuccessDialog("Account Created!", 
                        "Welcome, " + name + "! Your account has been created successfully.", true);
                });
            }
            ...
            public void onFailure(String error) {
                runOnUiThread(() -> {
                    ...
                    showErrorDialog("Signup Failed", userMessage);
                    Log.e(TAG, "Signup failed: " + error);
                    
                    // Set field-specific errors
                    String lowerError = error.toLowerCase();
                    if (lowerError.contains("email") && (lowerError.contains("use") || lowerError.contains("exists"))) {
    ...
    private String getUserFriendlyError(String error) {
        if (error == null) return "Signup failed. Please try again.";
